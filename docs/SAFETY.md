...
- Foreground-only, locally authenticated handling for Siri and Shortcuts actions.
...
- Route Siri and Shortcuts actions through the foreground app and the same iPhone control path.
